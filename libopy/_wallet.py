...
from fincorpy import BIP32DerivationError
from fincorpy.typing import Wallet

DEFAULT_DERIVATION_PATH = "m/44'/629'/0'/0/0"
DEFAULT_BECH32_HRP = "fincor"
...
def seed_to_privkey(seed: str, path: str = DEFAULT_DERIVATION_PATH) -> bytes:
    ...
    `fincorpy.BIP32DerivationError` if the resulting private key is
    invalid.
    """
    ...
    # that the same exception type is also in the `fincorpy` namespace).
