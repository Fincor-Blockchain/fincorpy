        ...
        "msgs": [
            {
                ...
                "value": {
                    "inputs": [
                        {
                            "address": "fincor1qperwt9wrnkg5k9e5gzfgjppzpqhyav5j24d66",
                            "coins": [{"amount": "1", "denom": "ffnr"}],
                        }
                    ],
                    "outputs": [
                        {
                            "address": "fincor1yeckxz7tapz34kjwnjxvmxzurerquhtrmxmuxt",
                            "coins": [{"amount": "1", "denom": "ffnr"}],
                        }
                    ],
                },
...
def test_get_pushable_tx():
    expected_pushable_tx = '{"tx":{"msg":[{"type":"cusp-sdk/MsgSend","value":{"from_address":"fincor1lgharzgds89lpshr7q8kcmd2esnxkfpwvuz5tr","to_address":"fincor103l758ps7403sd9c0y8j6hrfw4xyl70j4mmwkf","amount":[{"denom":"ffnr","amount":"387000"}]}}],"fee":{"gas":"37000","amount":[{"denom":"ffnr","amount":"1000"}]},"memo":"","signatures":[{"signature":"chbQMmrg18ZQSt3q3HzW8S8pMyGs/TP/WIbbCyKFd5IiReUY/xJB2yRDEtF92yYBjxEU02z9JNE7VCQmmxWdQw==","pub_key":{"type":"aphelion/PubKeySecp256k1","value":"A49sjCd3Eul+ZXyof7qO460UaO73otrmySHyTNSLW+Xn"},"account_number":"11335","sequence":"0"}]},"mode":"sync"}'  # noqa: E501
    ...
    tx.add_transfer(recipient="fincor103l758ps7403sd9c0y8j6hrfw4xyl70j4mmwkf", amount=amount)
