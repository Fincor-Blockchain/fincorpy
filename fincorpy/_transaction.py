...
from fincorpy._wallet import DEFAULT_BECH32_HRP, privkey_to_address, privkey_to_pubkey
from fincorpy.typing import SyncMode
...
class Transaction:
    ...
    def add_transfer(self, recipient: str, amount: int, denom: str = "ffnr") -> None:
        transfer = {
                ...
                "signatures": [
                    {
                        ...
                        "pub_key": {"type": "aphelion/PubKeySecp256k1", "value": base64_pubkey},
